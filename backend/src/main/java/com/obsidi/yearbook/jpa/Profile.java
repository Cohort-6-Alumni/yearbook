...
public class Profile implements Serializable {
	...
	public String toString() {
		return "Profile [profileId=" + profileId + ", bio=" + bio + ", interests=" + interests + ", hobbies=" + hobbies
				+ ", headline=" + headline + ", favoriteCodingSnack=" + favoriteCodingSnack + ", favoriteQuote="
				+ favoriteQuote + ", mostLikelyTo=" + mostLikelyTo + ", mostMemorableBootcampMoment="
				+ mostMemorableBootcampMoment + ", adviceForFutureCohort=" + adviceForFutureCohort
				+ ", biggestChallenge=" + biggestChallenge + ", howYouOvercameIt=" + howYouOvercameIt + ", lastWords="
				+ lastWords + ", picture=" + picture + ", user=" + user + ", getProfileId()=" + getProfileId()
				+ ", getBio()=" + getBio() + ", getInterests()=" + getInterests() + ", getHobbies()=" + getHobbies()
				+ ", getHeadline()=" + getHeadline() + ", getFavoriteCodingSnack()=" + getFavoriteCodingSnack()
				+ ", getFavoriteQuote()=" + getFavoriteQuote() + ", getMostLikelyTo()=" + getMostLikelyTo()
